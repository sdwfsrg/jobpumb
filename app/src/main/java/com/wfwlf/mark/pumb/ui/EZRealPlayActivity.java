...
import com.wfwlf.mark.pumb.manager.ScreenOrientationHelper;
import com.wfwlf.mark.pumb.util.ActivityUtils;
import com.wfwlf.mark.pumb.util.AudioPlayUtil;
import com.wfwlf.mark.pumb.util.DataManager;
import com.wfwlf.mark.pumb.util.EZUtils;
import com.wfwlf.mark.pumb.util.VerifyCodeInput;
import com.wfwlf.mark.pumb.widget.WaitDialog;
import com.wfwlf.mark.pumb.widget.loading.LoadingTextView;
...
//    private GoogleApiClient client;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MjlApplication.getOpenSDK().setAccessToken("at.03s1hsp7110xo7kz1yb7lx9o3d16ry5g-54ve89c0ai-0hw61lx-1h0p73ma9");
        initData();
        initView();
        // ATTENTION: This was auto-generated to implement the App Indexing API.
        // See https://g.co/AppIndexing/AndroidStudio for more information.
   ...
   private void  exit(){
    ...
    public void finish() {
        if (mCameraInfo != null){
            ...
            setResult(VideoRecodeActivity.RESULT_CODE, intent);
        }
        super.finish();
    }
    ...
    private void ptzOption(final EZPTZCommand command, final EZPTZAction action) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ptz_result = MjlApplication.getOpenSDK().controlPTZ(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo(), command,
            ...
            Thread thr = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        MjlApplication.getOpenSDK().setVideoLevel(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo(), mode.getVideoLevel());
...
//        mTalkPopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
    ...
    private void startRealPlay() {
        ...
        if (mCameraInfo != null) {
            if (mEZPlayer == null) {
                mEZPlayer = MjlApplication.getOpenSDK().createPlayer(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo());
            }
            ...
            mEZPlayer = MjlApplication.getOpenSDK().createPlayerWithUrl(mRtspUrl);
