...
public class GsonRequest extends Request<BaseVO>{
	 ...
	 * @param type
	 */
	public GsonRequest(String url, Type type, MyReponseListener listener, MyErrorListener errorListener) {
	...
	public GsonRequest(String url, Map<String, String> methodBoby, Type type,
                       MyReponseListener listener, MyErrorListener myErrorListener) {
